...
struct Dms(Sign, u32, u32, f64);

#[derive(Debug, PartialEq)]

struct Hms(Sign, u32, u32, f64);
...
mod tests {
    ...
    fn test_ams() {
        // Dms
        assert_eq!(Dms::from(Degree(0.0)), Dms(Sign::Plus, 0, 0, 0.0));
        assert_eq!(Dms::from(Degree(-0.0)), Dms(Sign::Minus, 0, 0, 0.0));
        assert_eq!(Dms::from(Degree(180.0)), Dms(Sign::Plus, 180, 0, 0.0));
        assert_eq!(Dms::from(Radian(0.0)), Dms(Sign::Plus, 0, 0, 0.0));
        assert_eq!(Dms::from(Radian(-0.0)), Dms(Sign::Minus, 0, 0, 0.0));
        assert_eq!(Dms::from(Radian(PI)), Dms(Sign::Plus, 180, 0, 0.0));
        assert_eq!(Dms::from(Hour(12.0)), Dms(Sign::Plus, 180, 0, 0.0));
        // Hms
        assert_eq!(Hms::from(Degree(0.0)), Hms(Sign::Plus, 0, 0, 0.0));
        assert_eq!(Hms::from(Degree(-0.0)), Hms(Sign::Minus, 0, 0, 0.0));
        assert_eq!(Hms::from(Hour(12.0)), Hms(Sign::Plus, 12, 0, 0.0));
        assert_eq!(Hms::from(Radian(0.0)), Hms(Sign::Plus, 0, 0, 0.0));
        assert_eq!(Hms::from(Radian(-0.0)), Hms(Sign::Minus, 0, 0, 0.0));
        assert_eq!(Hms::from(Radian(PI)), Hms(Sign::Plus, 12, 0, 0.0));
        assert_eq!(Hms::from(Degree(180.0)), Hms(Sign::Plus, 12, 0, 0.0));
    }
}
